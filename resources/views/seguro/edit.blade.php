                              ...
                              <div>
                                    <div id="form-step-0" role="form" data-toggle="validator">
                                      <div class="row" style="width:960px; margin: 20px auto;">
                                          ...
                                          <input type="text" value="{{$seguradora->nome}}" class="form-control has-feedback-left" placeholder="Nome da Seguradora:" name="nome">
                                              <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                            </div>
                                          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                              <input type="text" value="{{$seguradora->n_apolice}}" class="form-control has-feedback-left" placeholder="Nº da Apolice:" name="n_apolice">
                                              <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                            </div>
                                             <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                              ...
                                              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                              <input type="text" value="{{$seguradora->cobertura}}" class="form-control has-feedback-left" placeholder="Cobertura:" name="cobertura">
                                              <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                            </div>
                                      </div>
