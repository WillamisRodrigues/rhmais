                    ...
                    <table class="table list table-striped table-bordered">
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td style="width:24%;">
                                <div class="col-md-3">
                                <a href="{{route('assinar.avaliacao.estagiario', [$avaliacao->id])}}" class="btn btn-primary">
                                        <i class="fa fa-star"> </i> </a>
                                    </div>
                                    <a href="/editar_avaliacao_estagiario" class="btn btn-primary">
                                        <i class="fa fa-pencil"> </i> </a>
                                    </div>
                                    {{-- <form class="col-md-3 delete" action="{{route('deletar.avaliacao.estagiario', [$avaliacao->id])}}" method="POST"> --}}
                                        {{-- <input type="hidden" name="_method" value="DELETE"> --}}
                                        {{-- <input type="hidden" name="_token" value="{{ csrf_token() }}"> --}}
                                        {{-- <button type="submit" class="btn btn-danger"> --}}
                                                <a href="{{route('deletar.avaliacao.estagiario', [$avaliacao->id])}}" class="btn btn-danger">
