@extends('layout/app')
@section('titulo','Editar Cidade | RH MAIS')
@section('conteudo')
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <form action="{{ route('cidade.store') }}" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
                  {{csrf_field()}}
                              ...
                              <div id="step-1">
                                  ...
                                  <div class="row" style="width:960px; margin: 0 auto;">
                                    ...
                                    <div class="row" style="width:960px; margin: 0 auto;">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="text" class="form-control has-feedback-left" placeholder="Unidade Concedente" name="undcondente">
