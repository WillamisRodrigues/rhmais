                        ...
                        <tr>
                          ...
                          <td style="width:24%;">
                              ...
                              <a href="{{route('assinar.avaliacao.supervisor', [$avaliacao->id])}}" class="btn btn-primary">
                                  ...
                                  {{-- <form class="col-md-3 delete" action="{{route('deletar.avaliacao.supervisor', [$avaliacao->id])}}" method="POST"> --}}
                                      {{-- <input type="hidden" name="_method" value="DELETE"> --}}
                                      {{-- <input type="hidden" name="_token" value="{{ csrf_token() }}"> --}}
                                      {{-- <button type="submit" class="btn btn-danger"> --}}
                                              <a href="{{route('deletar.avaliacao.supervisor', [$avaliacao->id])}}" class="btn btn-danger">
