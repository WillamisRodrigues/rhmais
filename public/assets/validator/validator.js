...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : 'deve ser verificado',//'must be checked',
        empty           : 'campo obrigatório',//'please put something here',
        min             : 'termo muito curto',//'input is too short',
        max             : 'termo muito longo',//input is too long',
        number_min      : 'não atende o valor minimo',//'too low',
        number_max      : 'acima do permitido',//'too high',
        url             : 'URL inválida',//'invalid URL',
        number          : 'não é um número',//'not a number',
        email           : 'e-mail inválido',//'email address is invalid',
        email_repeat    : 'e-mail não correspondente',//'emails do not match',
        password_repeat : 'senha não correspondente',//'passwords do not match',
        repeat          : 'não correspondente',//'no match',
        complete        : 'entrada incompleta',//'input is not complete',
        select          : 'por favor, selecione uma opção.'//'Please select an option'
    };
